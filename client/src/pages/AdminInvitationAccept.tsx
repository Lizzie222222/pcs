...
interface InvitationDetails {
  ...
  expiresAt: string;
  status: string;
  authMethod: 'none' | 'password' | 'google' | 'both';
        ...
        <Card className="w-full max-w-lg shadow-xl border-0">
          ...
          <CardContent className="space-y-6">
            ...
            <div>
              ...
              {/* Show Google-only login if user signed up with Google */}
              {invitation.authMethod === 'google' && (
                <div className="space-y-4">
                  <div className="bg-blue-50 border border-blue-200 rounded-lg p-3">
                    <p className="text-sm text-blue-800 text-center" data-testid="text-google-account-notice">
              ...
              {/* Show password-only login if user has password */}
              ...
              {/* Show both options if user has both or is new */}
              {(invitation.authMethod === 'both' || invitation.authMethod === 'none') && (
                <>
