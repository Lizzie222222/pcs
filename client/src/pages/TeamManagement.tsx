                          ...
                          <div className="flex items-center gap-3">
                            ...
                            <div>
                              ...
                              <p className="text-xs text-gray-500" data-testid={`text-invitation-date-${invitation.id}`}>
                                {invitation.createdAt && `Sent ${format(new Date(invitation.createdAt), 'MMM dd, yyyy')}`}
                                {invitation.createdAt && invitation.expiresAt && ' • '}
                                {invitation.expiresAt && `Expires ${format(new Date(invitation.expiresAt), 'MMM dd, yyyy')}`}
                              </p>
                            </div>
                          </div>
