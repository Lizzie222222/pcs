          ...
          <div className="flex gap-1.5 w-full mt-auto pt-2">
            ...
            {isLocked ? (
              <Button
                size="sm"
                variant="outline"
                className="flex-1 h-8 px-2 text-xs bg-gray-100 text-gray-600 hover:bg-gray-200"
              ...
              <Button
                size="sm"
                className="flex-1 h-8 px-2 text-xs bg-coral hover:bg-coral/90 text-white shadow-md"
                onClick={() => handleDownload(resource.id, resource.fileUrl, resource.title, resource.visibility)}
                data-testid={`button-download-${resource.id}`}
              >
