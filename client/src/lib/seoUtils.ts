...
export const pageSEOData: PageSEOMap = {
  ...
  '/resources': {
    ...
    canonicalUrl: 'https://plasticcleverschools.org/resources'
  },
  '/inspiration': {
  ...
  '/schools-map': {
    ...
    ogImage: '/assets/Logo_1757848498470.png',
    canonicalUrl: 'https://plasticcleverschools.org/schools-map'
  },
  '/search': {
    ...
    ogImage: '/assets/generated_images/Kids_recycling_at_school_a7869617.png',
    canonicalUrl: 'https://plasticcleverschools.org/search'
  },
  '/register': {
  ...
  '/login': {
    ...
    ogImage: '/assets/Logo_1757848498470.png',
    canonicalUrl: 'https://plasticcleverschools.org/login'
  },
  '/admin': {
...
export function updatePageSEO(location: string, isAuthenticated?: boolean) {
  ...
  if (seoData.ogImage) {
    ...
    if (ogImage) {
      ogImage.setAttribute('content', `https://plasticcleverschools.org${seoData.ogImage}`);
    }
  }
